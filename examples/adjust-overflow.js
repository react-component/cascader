...
var MyCascader = function (_React$Component) {
  ...
  function MyCascader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MyCascader.__proto__ || Object.getPrototypeOf(MyCascader)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      inputValue: ''
